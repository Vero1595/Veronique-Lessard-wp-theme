 ...
 */
 function vero_theme_scripts() {
     wp_enqueue_style( 'vero', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'vero_theme_scripts' );
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'vero' ),
            'footer-menu' => __( 'Footer Menu', 'vero' ),
            'social-menu' => __( 'Social Menu', 'vero'),
